...
public final class Timber {
  ...
  private static final String WRITE_FILE_FLAG = "--file--";
  private static final Logger logger = LoggerFactory.getLogger(Timber.class);
  ...
  public static void fv(@NonNls String message, Object... args) {
  ...
  public static void fv(Throwable t, @NonNls String message, Object... args) {
  ...
  public static void fd(@NonNls String message, Object... args) {
  ...
  public static void fd(Throwable t, @NonNls String message, Object... args) {
  ...
  public static void fi(@NonNls String message, Object... args) {
  ...
  public static void fi(Throwable t, @NonNls String message, Object... args) {
  ...
  public static void fw(@NonNls String message, Object... args) {
  ...
  public static void fw(Throwable t, @NonNls String message, Object... args) {
  ...
  public static void fe(@NonNls String message, Object... args) {
  ...
  public static void fe(Throwable t, @NonNls String message, Object... args) {
  ...
  public static void fwtf(@NonNls String message, Object... args) {
  ...
  public static void fwtf(Throwable t, @NonNls String message, Object... args) {
  ...
  public static abstract class Tree {
    ...
    private void prepareLog(int priority, Throwable t, String message, Object... args) {
      ...
      boolean needWriteToFile = message.startsWith(WRITE_FILE_FLAG);
      if (!needWriteToFile && !isLoggable(tag, priority)) {
        return;
      }
  ...
  public static class DebugTree extends Tree {
     ...
     */
    @Override
    protected void log(int priority, String tag, @NotNull String message, Throwable exception) {
      boolean needWriteToFile = message.startsWith(WRITE_FILE_FLAG);
      if (needWriteToFile) {
        message = message.replace(WRITE_FILE_FLAG, "");

        String newMessage = tag + "：" + message;
        switch (priority) {
          case Log.VERBOSE: logger.trace(newMessage); break;
          case Log.DEBUG: logger.debug(newMessage); break;
          case Log.INFO: logger.info(newMessage); break;
          case Log.WARN: logger.warn(newMessage); break;
          case Log.ERROR: {
            if (exception != null) {
              logger.warn("发生了异常： " + exception.getMessage());
              logger.error(newMessage); // 有异常对象时，error级别的日志会单独保存在一个Bug文件中。
              //logger.error(newMessage, exception); // Timber对象已经把异常数据都封装到message对象中了，所以不需要用这个方法
            }  else{
